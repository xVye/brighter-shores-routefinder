...
import {deliveryData, DeliveryStatus} from "./deliveries.js";
...
class Pathfinder {
    ...
    #teleportZones = new Set(['Crenopolis Outskirts Portal Stone', 'Crenopolis Market Portal Stone'])
    ...
    findBestRoute(deliveries) {
        ...
        pq.enqueue({
            ...
            deliveryStates: [...new Array(deliveries.length)].map(() => DeliveryStatus.NOT_STARTED),
            actions: []
        });
            ...
            if (this.#canPurchaseMoreItems(deliveryStates)) {
                deliveries
                    ...
                    .forEach((d) => {
                        ...
                        const {distance: nextDistance} = GPS.distance(currentLocation, nextLocation);
                        pq.enqueue({
